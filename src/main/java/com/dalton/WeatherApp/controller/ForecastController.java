...
public class ForecastController {
    ...
    public Forecast getForecast(@PathVariable String location) {
        ...
        for (Map<String, Object> forecast : weatherList) {
        ...
        // Retrieve the first weather condition for the forecast
        List<Map<String, Object>> weatherConditions = (List<Map<String, Object>>) weatherList.get(0).get("weather");
        String icon = (String) weatherConditions.get(0).get("icon");

        return new Forecast(high, low, icon);
    }
}
